//----------------------------------------------------------------------------
// $Id: HexUctKnowledge.cpp 1898 2009-02-05 02:01:04Z broderic $
//----------------------------------------------------------------------------
...
void HexUctPriorKnowledge::ProcessPosition(bool& UNUSED(deepenTree))
{
	...
	//hex::log << hex::severe << "BAD:"
        //         << brd.printBitset(m_badResponses) << hex::endl;
    }
	...
	//hex::log << hex::severe << "GOOD:"
        //         << brd.printBitset(m_goodResponses) << hex::endl;
    }
}
