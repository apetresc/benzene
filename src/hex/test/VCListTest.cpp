//---------------------------------------------------------------------------
// $Id: VCListTest.cpp 1657 2008-09-15 23:32:09Z broderic $
//---------------------------------------------------------------------------
...
BOOST_AUTO_UNIT_TEST(VCList_Basic)
{
    ...
    BOOST_CHECK_EQUAL(vl.add(v1), VCList::ADDED_INSIDE_SOFT_LIMIT);
    BOOST_CHECK(!vl.empty());
    ...
    BOOST_CHECK_EQUAL(vl.add(v1), VCList::ADD_FAILED);
    BOOST_CHECK(!vl.empty());
    BOOST_CHECK_EQUAL(vl.size(), 1);
    ...
    BOOST_CHECK_EQUAL(vl.add(v2), VCList::ADD_FAILED);
    BOOST_CHECK(!vl.empty());
    BOOST_CHECK_EQUAL(vl.size(), 1);
    ...
    BOOST_CHECK_EQUAL(vl.add(v3), VCList::ADDED_INSIDE_SOFT_LIMIT);
    BOOST_CHECK(!vl.empty());
    ...
    BOOST_CHECK_EQUAL(vl.add(v4), VCList::ADDED_INSIDE_SOFT_LIMIT);
    BOOST_CHECK(!vl.empty());
    BOOST_CHECK_EQUAL(vl.size(), 2);
    ...
    BOOST_CHECK_EQUAL(vl.add(v5), VCList::ADDED_INSIDE_HARD_LIMIT);
    BOOST_CHECK(!vl.empty());
    ...
    // test remove(VC)
    BOOST_CHECK(!vl.remove(v4));
    BOOST_CHECK(vl.remove(v1));
    BOOST_CHECK_EQUAL(vl.size(), 1);
