//----------------------------------------------------------------------------
// $Id: Pattern.cpp 1536 2008-07-09 22:47:27Z broderic $
//----------------------------------------------------------------------------
...
bool Pattern::unserialize(std::string code)
{
    ...
    uint check = ~((1<<(MAX_EXTENSION*(MAX_EXTENSION+1)/2))-1);
                                   ...
                                   std::vector<Pattern>& out)
{
    ...
    if (!f) {
        hex::log << hex::warning;
        hex::log << "Could not open file '" << filename << "'!" << hex::endl;
    }
