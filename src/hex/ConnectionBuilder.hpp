//----------------------------------------------------------------------------
// $Id: ConnectionBuilder.hpp 1908 2009-02-11 08:49:45Z broderic $
//----------------------------------------------------------------------------
...
struct ConnectionBuilderParam
{
    ...
    /** Whether to use the push rule.
        @todo DOCUMENT PUSH RULE! */
    bool use_push_rule;
...
struct ConnectionBuilderStatistics
{
    ...
    /** Semi-connections built by push-rule. */
    int push_attempts;
    
    /** Semi-connections successfully added by push-rule. */
    int push_successes;
...
private:
    ...
    */
    ...
    void doPushRule(const VC& vc, const VCList* semi_list);
